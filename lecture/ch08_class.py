...
# Class(힐스테이트 설계 도면) → 객체생성 → 수완동(수완 힐스테이트: 인스턴스)
# Class(힐스테이트 설계 도면) → 객체생성 → 봉선동(봉선 힐스테이트: 인스턴스)
# Class(힐스테이트 설계 도면) → 객체생성 → 지산동(지산 힐스테이트: 인스턴스)
